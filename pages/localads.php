  ...
  <div class="row">
   <div class="col-md-12 col-sm-12 col-xs-12 wow fadeInLeft">
    <div class="slider-content text-center">
     <h2 class="slider-title">Local Ads </h2>
 ...
 <div class="container">
  <div class="row">
   <div class="heading-inner text-center">
    <h2 class="sec-title">Sitelettes <span>Droplet</span></h2>
    <p>
     Vero doloribus dignissimos, unde architecto sapiente ea expedita non magnam aliquam.
    </p>
   </div>
  </div>
  <!-- heading row end -->
     ...
     <div class="col-md-12 wow slideInLeft" data-wow-delay=".3s">
      <div class="about-inner ">
       ...
       <div class="about-content">
        ...
        <p>
         Architecto provident eaque mollitia, et repellendus commodi dignissimos aspernatur.et repellendus commodi dignissimos aspernatur.
        </p>
       </div>
      </div>
     </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 feature-bg wow fadeInUp" data-wow-delay=".3s">
     <div class="feature-inner text-center">
      ...
      <div class="feature-content">
       ...
       <p>
        Odit temporibus, reprehenderit eum.
       </p>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12 feature-bg white wow fadeInUp" data-wow-delay=".5s">
     <div class="feature-inner text-center">
      ...
      <div class="feature-content">
       <h3>Powerful code</h3>
       <p>
         Replace this with meaningful text
      </p>
       <a href="#" class="read-more">Read more</a>
      </div>
     </div>
 ...
 <div class="container">
  ...
  <div class="row">
   <div class="carousel slide" id="app-carousel" data-ride="carousel">
    ...
    <!-- carousel-inner end -->
    <!-- Controls -->
    <a class="left carousel-control" href="#app-carousel" role="button" data-slide="prev"> <span aria-hidden="true"><img src="images/arrow-left.png" alt=""></span> </a>
    <a class="right carousel-control" href="#app-carousel" role="button" data-slide="next"> <span  aria-hidden="true"> <img src="images/arrow-right.png" alt=""></span> </a>
   </div>
  </div>
 </div>
</section>
     ...
     <ul class="item-list-left">
      ...
      <li class="wow fadeInDown" data-wow-delay=".6s">
       ...
       <div class="item-content">
        ...
        <p>
         Today Intro is a very important element of any project. It can be named even a face of the project.
        </p>
       </div>
      </li>
       ...
       <div class="item-content">
        <ul>
         <li class="wow fadeInDown" data-wow-delay=".3s">
          ...
          <p>
           Quibusdam provident libero dolorum, sit deleniti ad iure.
          </p>
         </li>
         <li class="wow fadeInDown" data-wow-delay=".6s">
  ...
  <div class="row">
   <div class="col-md-7 wow fadeInLeft" data-wow-delay=".3s">
    <div class="download-inner text-left">
     ...
     <p>
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eum pariatur, quam, cumque similique dignissimos cupiditate deserunt consequatur vitae, voluptas illo quos fuga nisi blanditiis ex dolore beatae odio eligendi neque.
     </p>
   ...
   <div class="col-md-12 col-xs-12">
    <div id="client-carousel" class=" owl-carousel owl-theme text-center client-carousel">
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client1.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client2.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client3.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client4.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client5.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client6.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client7.png" alt="client"> </a>
     </figure>
     <figure class="item client_logo">
      <a href="#"> <img src="images/clients/client8.png" alt="client"> </a>
     </figure>
